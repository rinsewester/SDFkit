...
\label{sec:approach}
  ...
  \begin{itemize}
    \item computational structures: \todo[inline]{elaborate a bit... big data programmers are already familiar with a structural approach to programming like hadoop}
    \item CSDF graphs and transformations
    \item simulation
    \item hardware generation using \clash \cite{Baaij10}
  \end{itemize}
