...
\label{sec:approach}
  ...
  \todo{ref to thesis Rinse \cite{Wester15}}
  ...
  \todo{ref naar thesis Robert \cite{deGroote16}}
  ...
  \todo[inline]{mention CLaSH \cite{Baaij10} as used for backend}
...
\label{sec:conclusions}
  ...
  \todo[inline]{Future work: Complete support for CSDF, hierarchy is design environment, multicore and GPU code generation}
