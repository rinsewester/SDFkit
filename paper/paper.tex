...
\section{Introduction}
  ...
  In our approach, we take as input a mathematical\todo{Functional, declarative?} description of the application, and transform it into a \emph{cyclo-static dataflow} (CSDF) graph~\cite{bilsen1996}.
