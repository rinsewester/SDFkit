...
The JSON based file format for graphs is described in :ref:`sect-graph-file-format`.

The class on which all modeling and simulation is based, the CSDFGraph class, is documented in :ref:`sect-csdfgraph-class`.
